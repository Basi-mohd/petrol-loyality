...
const reconciliation_module_1 = require("../../infrastructure/reconciliation/reconciliation.module");
...
exports.ReconciliationModule = ReconciliationModule = __decorate([
    (0, common_1.Module)({
        imports: [reconciliation_module_1.ReconciliationModule],
        exports: [reconciliation_module_1.ReconciliationModule],
    })
