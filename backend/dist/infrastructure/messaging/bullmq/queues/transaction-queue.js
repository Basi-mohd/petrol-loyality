...
exports.createTransactionQueue = void 0;
...
const createTransactionQueue = (configService) => {
    const config = (0, bullmq_config_1.getBullMQConfig)(configService);
    return new bullmq_1.Queue(queue_names_constants_1.QUEUE_NAMES.TRANSACTION, {
